...
-- INSERT INTO books (id, title, year, series_id) VALUES (1, "that book", 1996, 1), (2, "of mice and men", 1998, 1), (3, "a comprehensive guide on how to read", 2000, 1), (4, "anotherbook", 2002, 2), (5, "yet another book", 2003, 2), (6, "the last book", 2005, 2);


-- INSERT INTO characters (id, name, species, motto, author_id) VALUES (1, "cat", "Woof Woof", "cat", 1), (2, "dog", "meow meow meow", "dog", 1), (3, "garen", "FOR THE GLORY OF DEMACIA", "human", 1), (4, "smeagul", "GIVE US THE RING", "human", 1);

-- INSERT INTO subgenres (id, name) VALUES (id, name) VALUES (1, "awesome"), (2, "probably cooler");

-- INSERT INTO authors (id, name) VALUES (1, "lord of the rings guy"), (2, "CS lewis");
